...
import { addCreditInfo, getBasicInfo, getCreditInfo } from 'src/redux/candidateSlice'
...
const Approve = () => {
  ...
  const handleApprove = async () => {
    ...
    const newCustomer = {
      ...
      businessType: newUser.data.businessType,
      numberOfBranches: newUser.data.numberOfBranches,
      numberOfEmployees: newUser.data.numberOfEmployees,
      expectedCredit: newUser.data.expectedCredit,
