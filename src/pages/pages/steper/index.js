                    ...
                    <Box autoHideDuration={5000} square elevation={0} sx={{ p: 3 }}>
                        ...
                        >
                            ...
                            <Link href='/' onClick={e => e.preventDefault()}>
                                You have sent all information successfully as soon as we review your info we will send you log in password to access your account
                            </Link>
                        </Alert>}
                        {openAlert1 && <Alert
                        ...
                        >
                            ...
                            <Link href='/' onClick={e => e.preventDefault()}>
                                Please try again
                                <Button
                                    onClick={() => router.push('/')} sx={{ mt: 1, mr: 1 }}>
                                    Get Back
                                </Button>
                            </Link>
                        </Alert>}
                        <Button
                            hidden={steps.length - 1} onClick={handleReset} sx={{ mt: 1, mr: 1 }}>
                            Reset
                        </Button>
                        <Button
                            hidden={!steps.length - 1} onClick={() => router.push('/')} sx={{ mt: 1, mr: 1 }}>
                            Get Back
                        </Button>
                    </Box>
                )}
