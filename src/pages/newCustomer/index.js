  ...
  return (
    <Box>
      <Grid container spacing={2}>
        <div
          className='tm_invoice_info tm_mb25'
          style={{ backgroundColor: 'white', padding: '10px', display: 'flex', width: '100%' }}
        >
          <div
            className='tm_card_note tm_mobile_hide'
            style={{ width: '100%', display: 'block', justifyContent: 'space-between' }}
          >
            ...
            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              ...
              <span>
                {' '}
                <h6 style={{ color: 'red' }}> {userInfos.name}</h6>
              </span>
            </div>
            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              <h6 className='tm_primary_color'>Email: </h6>&nbsp;&nbsp;{' '}
              <span>
                {' '}
                <h6 style={{ color: 'red' }}> {userInfos.email}</h6>
              </span>
            </div>

            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              <h6 className='tm_primary_color'>Business Type: </h6>&nbsp;&nbsp;{' '}
              <span>
                {' '}
                <h6 style={{ color: 'red' }}> {userInfos.businessType}</h6>
              </span>
            </div>
            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              <h6 className='tm_primary_color'>Business Branches: </h6>&nbsp;&nbsp;{' '}
              <span>
                {' '}
                <h6 style={{ color: 'red' }}> {userInfos.numberOfBranches}</h6>
              </span>
            </div>
          </div>
          <div
          ...
          >
            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              <h6 className='tm_primary_color'>Phone number: </h6> &nbsp;&nbsp;
              <span>
                {' '}
                <h6 style={{ color: 'red' }}> {userInfos.phone}</h6>
              </span>
            </div>
            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              <h6 className='tm_primary_color'>Company: </h6>&nbsp;&nbsp;{' '}
              <span>
                {' '}
            ...
            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              <h6 className='tm_primary_color'>Expected Credit: </h6>&nbsp;&nbsp;{' '}
              <span>
                {' '}
                <h6 style={{ color: 'red' }}> {userInfos.expectedCredit} ETB</h6>
              </span>
            </div>
            <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
              <h6 className='tm_primary_color'>Number Of Employees: </h6>&nbsp;&nbsp;{' '}
              <span>
                {' '}
                <h6 style={{ color: 'red' }}> {userInfos.numberOfEmployees}</h6>
              </span>
            </div>
          </div>
