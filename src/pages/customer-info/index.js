      ...
      <ApexChartWrapper>
        <Grid container spacing={6}>
          ...
          <Box mt={2} textAlign='right'>
            <ReactToPrint
              trigger={() => (
                <Button style={{ margin: '10px' }} variant='outlined' color='primary' onClick={handlePrints}>
                  Print
                </Button>
              )}
              content={() => componentRef.current}
          ...
          <Grid item xs={12} ref={componentRef}>
            ...
            <Grid item xs={12}>
              <Grid container spacing={2}>
                ...
                >
                  <img
                    src={process.env.NEXT_PUBLIC_API_URL + 'file/' + userInfos.profilePicture}
                    alt='Logo'
                    style={{ width: '15rem', height: '15rem', marginRight: '15rem' }}
                  />
                  <div
                  ...
                  >
                    ...
                    <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
                      <h6 className='tm_primary_color'>Approved by: </h6>&nbsp;&nbsp;{' '}
                      <span>
                        {' '}
                        <h6 style={{ color: 'red' }}> {userInfos.approvedBy}</h6>
                      </span>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    {userInfos.updatedAt && (
                      <div className='tm_card_note tm_mobile_hide' style={{ display: 'flex' }}>
                        ...
                        <span>
                          {' '}
                          <h6 style={{ color: 'red' }}> {userInfos.updatedAt.slice(0, 10)}</h6>
                        </span>
                      </div>
                    )}
                  </div>
