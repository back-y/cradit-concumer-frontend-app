          ...
          <Grid container justifyContent='center' alignItems='center' style={{ padding: '20px' }}>
            <Grid item xs={12} md={6} style={{ padding: '10px' }}>
              ...
              >
                ...
                {loading ? (
                  ...
                  <Typography style={{ marginLeft: '10px' }} color='white' gutterBottom>
                    Shop
                  </Typography>
                )}
              </Button>
              <Typography style={{ marginLeft: '10px', color: 'green' }} color='white' gutterBottom>
            ...
            <Grid item xs={12} md={6} style={{ padding: '10px' }}>
              <Button
                ...
                color='inherit'
                size='large'
                style={{ padding: '10px', background: 'black', margin: '20px' }}
                onClick={goToLogin}
                disabled={loading2}
              >
                {loading2 ? (
                  ...
                  <Typography style={{ marginRight: '10px' }} color='white' gutterBottom>
                    Login
                  </Typography>
                )}
              ...
              <Typography style={{ marginRight: '10px', color: ' black ' }} color='white' gutterBottom>
